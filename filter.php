...
function mediaplugin_filter_callback($link, $type) {
    ...
    if ($type=="flv"){ 
      $mp4_url = str(replace($extn, '.mp4', $url);
    } else {
      $mp4_url = $url;
    }
...
<p>
  ...
  <a href="'.$mp4_url.'">MPEG4 / H.264 - (Windows / Mac compatible)</a>
